...
-- 정답: 3
-- AND가 OR보다 우선순위가 높으므로 (price > 50000 AND stock <= 20) 조건이 먼저 평가된 후,
-- 그 결과를 OR price < 20000 조건과 결합
...
-- 정답: 2
-- OR이 괄호로 묶여 있으므로 (category = '전자기기' OR category = '가구')가 먼저 평가되고,
-- 그 결과에서 AND price >= 50000 조건이 적용
